...
private:
   ...
   void test_destroyMain()
   {
      ...
      assertEquals(h.isDead(), true);
      assertEquals(satellites.size(), 10);  // 4 pieces
   }
   ...
   void test_destroyTelescope()
   {
      ...
      std::list<Satellite*> satellites;
      satellites.push_back(&telescope);
      satellites.push_back(&telescope);
      satellites.push_back(&telescope);
      satellites.push_back(&telescope);
      satellites.push_back(&telescope);
      ...
      assertEquals(telescope.isDead(), true);
      assertEquals(satellites.size(), 9);  // 3 fragments
   }
   ...
   void test_destroyComputer()
   {
      ...
      assertEquals(computer.isDead(), true);
      assertEquals(satellites.size(), 8);  // 2 fragments
   }
   ...
   void test_destroyLeftArray()
   {
      ...
      assertEquals(array.isDead(), true);
      assertEquals(satellites.size(), 8);  // 2 fragments
   }
